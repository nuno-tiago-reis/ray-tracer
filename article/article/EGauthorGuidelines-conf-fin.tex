...
\begin{figure}[!htb]
    ...
    \includegraphics[scale=0.30]{images/bounding-cone-2d.jpg}
    \caption{\label{fig:bc}Bounding Cone - 2D View}

    \vspace{2.5pt}

    \includegraphics[scale=0.30]{images/bounding-sphere-2d.jpg}
...
\begin{figure}[!htb]
    \centering
    \includegraphics[scale=0.30]{images/cone-union.png}
...
\begin{table*}[!htb]
\begin{center}
\includegraphics[width=0.45\textwidth]{images/chart}
\vskip 1em
\fontencoding{T1}
\fontseries{m}
\fontshape{sc}
...
\begin{center}
    \includegraphics[scale=0.45]{images/office} \\
    \textsc{Office} \\
    \vskip 1em

    \includegraphics[scale=0.45]{images/cornell} \\
    \textsc{Cornell} \\
    \vskip 1em

    \includegraphics[scale=0.45]{images/sponza}   \\
    \textsc{Sponza} \\
    \vskip 1em
\end{center}
